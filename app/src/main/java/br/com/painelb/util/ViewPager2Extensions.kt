...
fun ViewPager2.setSaveCurrentItem(index: Int) {
    setSaveCurrentItem(index, false)
}

fun ViewPager2.setSaveCurrentItem(index: Int, animate: Boolean = false) {
    if (adapter != null && index < adapter!!.itemCount && index > -1 && currentItem != index) {
